/**
 * Wappalyzer
 * @see {@link https://github.com/autogram-is/spidergram/blob/main/types/wappalyzer-core/index.d.ts}
 */
declare module 'wappalyzer-core' {
	...
	export interface Technology {
		 ...
		 */
		cookies?: Record<string, object | string>;
		 ...
		 * `js: { "jQuery.fn.jquery": "" }`
		 */
		js?: Record<string, object | string>;
